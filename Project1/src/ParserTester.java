...
public class ParserTester {
    ...
    Stream<DynamicTest> ValidTest() {
        ...
        Valid.add("Turl");
        Valid.add("Tpara");
        Valid=(ArrayList<String>) Valid.stream().map((String n)-> "tests/"+n+".txt").collect(Collectors.toList());
    ...
    Stream<DynamicTest> NonValidTest() {
        ...
        ArrayList<String> NonValid = new ArrayList<>(Arrays.asList("NonValid_0", "NonValid_1", "NonValid_2",
                        "NonValid_3", "NonValid_4", "NonValid_5",
                        "NonValid_6", "NonValid_7", "NonValid_8",
                        "NonValid_9"));

        NonValid=(ArrayList<String>) NonValid.stream().map((String n)-> "tests/"+n+".txt").collect(Collectors.toList());
